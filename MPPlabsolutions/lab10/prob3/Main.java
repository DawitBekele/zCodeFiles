...
public class Main {
	...
	public static <T > Boolean genericContains(List<? extends T> list,  T e, 
	...
	boolean foundIt = Main.genericContains(list, m, 
	...
	public static void test5() {
		...
		boolean foundIt = Main.genericContains(list, a, 
